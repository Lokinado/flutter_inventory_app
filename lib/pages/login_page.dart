  ...
  Widget build(BuildContext context) {
    return Scaffold(
      resizeToAvoidBottomInset:
          false, //to avoid the keyboard to resize the page
        ...
        child: Center(
          ...
          child: Column(
            ...
            children: [
              ...
              //username textfield
              MyTextField(
                //to use the textfield from the components folder
                controller:
                    usernameController, //to get what the user typed in the textfield in username
                hintText:
                    'Nazwa Użytkownika', //i hint to the user to that he should type his username
                obscureText: false,
              ), //here we dont hide the contents of the textfield
              ...
              MyTextField(
                ...
                hintText:
                    'Hasło', // i hint to the user to that he should type his password
                obscureText: true,
              ), //here we hide the contents of the textfield
              const SizedBox(height: 25),
